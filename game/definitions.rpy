...
image cg slightsmile:
    "cg/ch_0_slight_smile.png"
    yalign 0.2
    zoom 1.2

image cg slightfrown:
    "cg/ch_0_slight_frown.png"
    yalign 0.2
    zoom 1.2

image cg thot:
    "cg/ch_0_thoughts.png"
    yalign 0.2
    zoom 1.2
...
define m = DynamicCharacter('m_name', image='monika', what_prefix='"', what_suffix='"', color="#ffffff", window_style="textbox_monika", who_outlines=[ (3, "#77a377") ])
define n = DynamicCharacter('n_name', image='natsuki', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define y = DynamicCharacter('y_name', image='yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define ny = Character('Nat & Yuri', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")


define mon_default = DynamicCharacter('mon_default', image='monika', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
define mc_default = DynamicCharacter('player', what_prefix='"', what_suffix='"', ctc="ctc", ctc_position="fixed")
...
define chat_model_dict = {
    ...
    "groq": {
        "suggested": ["llama-3.1-70b-versatile", "llama3-70b-8192"],
        "other": []
    }
}
